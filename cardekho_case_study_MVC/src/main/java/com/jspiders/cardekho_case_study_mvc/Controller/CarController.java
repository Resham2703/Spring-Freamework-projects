...
public class CarController {
	...
	public String homePage() {
		return "Home"; // what content should be return. when client GET request sends to /home URL. 
	}
	...
	@PostMapping("/add")
	public String AddCar(@RequestParam String carName, @RequestParam String carBrand, @RequestParam String carFual,
			@RequestParam double carPrice, ModelMap map) {

		CarPojo pojo = service.addCar(carName, carBrand, carFual, carPrice);
	...
	public String update(@RequestParam int id, @RequestParam String carName, @RequestParam String carBrand,
			@RequestParam String carFual, @RequestParam double carPrice, ModelMap  map) {
		CarPojo pojo = service.updateCar(id, carName, carBrand, carFual, carPrice);
